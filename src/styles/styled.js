...
export const NavbarStyle = styled.div`
    ...
    .navbar-modal div, .navbar-menu-main div{
        width: 120px;
    }    
...
export const MainStyle = styled.div`
    ...
    .main-visual-slogan {
        ...
        text-align: center;
        padding: 60px 85px;
        background: url("https://ice.hufs.ac.kr/sites/ice/images/main/slogan_bg01.png") no-repeat left top, url("https://ice.hufs.ac.kr/sites/ice/images/main/slogan_bg02.png") no-repeat left bottom;
    ...
    .main-intro-gnuvil, .main-history-gnuvil, .main-review-gnuvil{
        margin-top: 30px;
    }
