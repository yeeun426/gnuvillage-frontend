            ...
            <div className="navbar-right-area">
                <div className="navbar-menu">
                    <div className = "navbar-menu-main">
                        <div><Link to ="/intro">Introduction</Link></div>
                        <div><Link to ="/study">Study</Link></div>
                        <div><Link to ="/together">Together</Link></div>
                        <div><Link to ="/notice">Notice</Link></div>
                        <div><Link to ="/recruit">Recruit</Link></div>
                    </div>
                
                    <div className="navbar-modal">
                        <div className='navbar-modal-intro'>
                            <Link to ="/intro"><div>동아리 소개</div></Link>
                            <Link to ="/history"><div>히스토리</div></Link>
                            <div>활동사진</div>
                            <div>운영진 연락처</div>
                        </div>
