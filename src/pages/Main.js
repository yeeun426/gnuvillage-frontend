    ...
    <MainStyle>
      ...
      <div className = "main-title-img">
        ...
        <div className = "main-visual-slogan">
          ...
          <div className="main-slogan-name">그누빌<span>(Gnuvil)</span></div>
      ...
      <div className="main-wrapper">
        <div className = "main-intro-gnuvil">
          <div className="main-sub-title">
            <span>Gnuvil은?</span>
            <Link to = "/intro"><button><BsArrowRight/></button></Link>
          </div>
        ...
        <div className = "main-history-gnuvil">
          <div className="main-sub-title">
            <span>History</span>
            <Link to = "/history"><button><BsArrowRight/></button></Link>
          </div>
          ...
          <div className="main-history-container">
            <div className = "main-history-items">
              ...
              <div className = "main-history-dot">
              </div>
